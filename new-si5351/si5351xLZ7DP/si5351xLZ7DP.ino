...
#define CW_TIMEOUT (300l) // in milliseconds, this is the parameter that determines how long the tx will hold between cw key downs
...
int_fast32_t rxbfo=5998932;  //BFO generator 
int_fast32_t rxRIT=0;
int RITon=0;
int_fast32_t rx600hz=800;   // cw offset  700
long cal=130;
...
void checkCW(){
  ...
  if ((keyDown == 1) && (keyerON == HIGH)){
     ...
     si5351.set_freq((((rx-rxif)+rxRIT+rx600hz)*100LL), SI5351_CLK1);
     si5351.output_enable(SI5351_CLK1, 1);
