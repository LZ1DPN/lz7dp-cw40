...
char keyDown = 0;   // keyer down temp vat - 1
...
//int32_t freq = ((rxif - frequency) + rxRIT) * 4294967296./180000000;  // note 180 MHz clock on 9851. also note slight adjustment of this can be made to correct for frequency error of onboard crystal
